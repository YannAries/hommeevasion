...
import {
  ...
  CartItems,
  DefaultAddress,
} from "components/molecules/Cart/";
...
const Cart = ({  }: Props) => {
  ...
  useEffect(() => {
    if (user.defaultAddressId)
      setDefaultAddr(
        addresses.find((addr: any) => addr.id === user.defaultAddressId)
      );
  }, [user, addresses]);
    ...
    <ProductScreenTemplate>
      <Container>
        ...
        {!loading && !cartItems.length && (
          <h3>
            Le panier est vide. <Link to="/search">Continuer à magasiner</Link>
          </h3>
        )}
          ...
          <Row>
            ...
            <Col>
              <CartSummary
                ...
                updateNetPaybleAmt={setNetPayableAmt}
              />
              <br />
              ...
              <Button
                block
                onClick={() =>
                  processPaymentRazorpay(netPayableAmt, placeOrder)
                }
