      ...
      <Row>
        {showModal && (
          <AddEditAddress
            ...
            addressToEdit={editIdx >= 0 ? addresses[editIdx] : null}
          />
        )}
      </Row>
      <Row>
            ...
            <Col sm={4} key={address.id}>
              ...
              >
                ...
                <Card.Footer
                  className={
                    address.id === user.defaultAddressId
                      ? styles.defaultAddrFooter
                      : undefined
                  }
                >
                  {address.id === user.defaultAddressId && (
                    <span>
                      <FaCheck /> Adresse par défaut
                    </span>
                  )}
                  {address.id !== user.defaultAddressId && (
                    <Button
                      variant="light"
                      onClick={(e: any) => handleSetDefaultAddr(e, address.id)}
                    >
                      Set as Default
                    </Button>
                  )}
