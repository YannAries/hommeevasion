...
const BreadCrumbs = ({  }: Props) => {
  ...
  return (
    <div className={cx(styles["page__section"])}>
      <nav
        className={cx(styles["breadcrumb"], styles["breadcrumb_type4"])}
            ...
            if (idx !== pages.length - 1) {
              return (
                <li key={idx} className={cx(styles["breadcrumb__group"])}>
                  ...
                  <span
                    className={cx(styles["breadcrumb__divider"])}
                    aria-hidden="true"
                  >
                    /
                  </span>
              ...
              return (
                <li key={idx} className={cx(styles["breadcrumb__group"])}>
                  <span
                    className={cx(styles["breadcrumb__point"])}
                    aria-current="page"
                  >
                    {toTitleCase(el)}
                  </span>
